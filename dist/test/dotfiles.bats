...
@test 'should run configuration' {
  ...
  assert_line --index 7 --regexp "'/tmp/.*/brew.plugin.bash' -> '/home/user/dotfiles/dist/test/fixtures/packages/brew/content/brew.plugin.bash'"
...
@test 'should load base cm: base1 and base2' {
  ...
  run bash "${DIST_PATH}/dotfiles" dummy
  assert_success
